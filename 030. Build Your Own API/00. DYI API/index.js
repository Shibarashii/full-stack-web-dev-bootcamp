...
app.patch('/jokes/:id', (req, res) => {
  try {
    ...
    jokes[index] = {
      ...jokes[index],
      ...(req.body.text ? { jokeText: req.body.text } : {}),
      ...(req.body.type ? { jokeType: req.body.type } : {}),
    };
    res.json(jokes);
  } catch (error) {
    console.log(error);
...
app.delete('/jokes/:id', (req, res) => {
  try {
    ...
    console.log(error);
    res.json({
      error: `Joke with id: ${req.params.id} not found. No jokes deleted`,
    });
  }
});
...
app.delete('/all', (req, res) => {
  if (req.query.key == masterKey) {
    jokes = [];
    console.log('Successfully deleted all jokes.');
    res.json(jokes);
  } else {
